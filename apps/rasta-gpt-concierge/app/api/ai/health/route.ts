...
export async function GET() {
  const configured = {
    ...
    userRateLimit: Boolean(process.env.RASTAGPT_USER_REQUESTS_PER_MINUTE),
  ...
  return NextResponse.json({
    ...
    productionReady: configured.openai
      && configured.firebaseAdmin
      && configured.userDailyBudget
      && configured.platformMonthlyBudget,
    configured,
    models: {
